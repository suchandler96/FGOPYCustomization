...
# Some personal understanding of some varaibles in `FGO-py/FGO-py/fgoKernel.py`
...
# Some tips
1. Customization is in fact against the design principle of FGO-py. So please be cautious when you want to send a issue or pull request to the FGO-py project.
